 ...
 * @since 11/03/2018
 */
class Tarifas extends Authenticatable
{
     ...
     * @var string
     */
    protected $primaryKey = 'codtarifa';
    ...
    protected $fillable = [
        ...
        'costo_envia',// numeric,
        'porcentaje_envia',// numeric,
        'costo_paga',// numeric,
        'porcentaje_paga',// numeric,,// timestamp without time zone,',// varchar (255),
    ];
