...

{
...

    {
        ...
        return $this->belongsToMany('App\Models\Sucursal', 'rel_empleado_sucursal', 'codempleado', 'codsucursal');
...

    {
        ...
        return $this->hasOne('App\Models\Usuario', 'codempleado','codempleado');
...

    {
        ...
        return $this->hasMany('App\Models\Sucursal', 'cod_punto');
