...

{
    ...
    protected $primaryKey = 'codsucursal';
...

    {
        ...
        return $this->hasMany('App\Models\Documento', 'codsucursal');

    }



    public function movimientos_soat()
    {
        return $this->belongsToMany('\App\Models\Soat', 'rel_sucursal_movimiento', 'codsucursal', 'codsoat')->withPivot('*');
    }
...

    {
        ...
        return $this->hasMany('App\Models\Apertura', 'codsucursal');
...

    {
        ...
        return $this->hasMany('App\Models\Movimiento', 'codsucursal');
...

    {
        ...
        return $this->hasMany('App\Models\Consignacion', 'codsucursal');
    ...
    public function movimientos_comision()
    {
        return $this->belongsToMany('\App\Models\Movimiento', 'rel_sucursal_movimiento', 'codsucursal', 'codmovimiento')->withPivot('*');
    }


    public function movimientos_consignacion()
    {
        return $this->belongsToMany('\App\Models\Consignaciones', 'rel_sucursal_movimiento', 'codsucursal', 'codconsignacion')->withPivot('*');
    }

    public function movimientos_recargas()
    {
        return $this->belongsToMany('\App\Models\Recarga', 'rel_sucursal_movimiento', 'codsucursal', 'codrecarga')->withPivot('*');
    }

    public function movimientos_pagos()
    {
        return $this->belongsToMany('\App\Models\Pagos', 'rel_sucursal_movimiento', 'codsucursal', 'codpago')->withPivot('*');
    }
