...

{
...

    {
        ...
        return $this->belongsToMany('App\Models\Cliente', 'movimientos', 'codcliente_envia', 'codcliente_recibe');
...

    {
        ...
        return $this->hasMany('App\Models\Movimiento', 'codcliente_envia');
    ...
    {
        return $this->hasMany('App\Models\Movimiento', 'codcliente_recibe');
    }
