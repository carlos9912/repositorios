...
class Apertura extends Authenticatable
{
     ...
     * @var string
     */
    protected $table = 'rel_sucursal_caja';
    ...
    protected $fillable = [
        'codrel',// serial constraint pk_codsuccaja primary key,
        'codsucursal',// integer,
        'empleado_registra',// integer,
        'tipo_registro',// smallint,
        'estado',// smallint,
        'fecha',// timestamp without time zone
        'fecha_cierre',// smallint,
        'empleado_cierra',// timestamp without time zone
    ];
